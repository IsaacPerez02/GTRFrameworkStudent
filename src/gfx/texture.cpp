...
namespace GFX
{
	...
	*/
	...
	void Texture::uploadAsArray(unsigned int texture_size, bool mipmaps)
	{
		...
		glTexParameteri(this->texture_type, GL_TEXTURE_MAG_FILTER, Texture::default_mag_filter);	//set the min filter
		glTexParameteri(this->texture_type, GL_TEXTURE_MIN_FILTER, this->mipmaps ? Texture::default_min_filter : GL_LINEAR); //set the mag filter
		glTexParameteri(this->texture_type, GL_TEXTURE_WRAP_S, this->mipmaps ? GL_REPEAT : GL_MIRRORED_REPEAT);
		glTexParameteri(this->texture_type, GL_TEXTURE_WRAP_T, this->mipmaps ? GL_REPEAT : GL_MIRRORED_REPEAT);
	...
	void Texture::generateMipmaps()
	{
		...
		{
			glTexParameteri(this->texture_type, GL_TEXTURE_WRAP_S, GL_MIRRORED_REPEAT); //set the mag filter
			glTexParameteri(this->texture_type, GL_TEXTURE_WRAP_T, GL_MIRRORED_REPEAT); //set the mag filter
		}
